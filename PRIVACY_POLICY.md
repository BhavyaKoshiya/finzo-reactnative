# Finzo — Privacy Policy

**Effective Date:** August 15, 2026  
**Last Updated:** August 15, 2026  
**Application:** Finzo — Personal Finance & Loan Calculator  
**Developer & Operator:** BinaryKode Technologies ("BinaryKode", "we", "our", or "us")  
**Contact Email:** [bhavyakoshiya.work@gmail.com](mailto:bhavyakoshiya.work@gmail.com)  
**Registered Address:** Surat, Gujarat, India - 394101  
**Authoritative Public Policy URL:** https://binarykode-technologies.web.app/pages/finzo-privacy-policy.html

---

## 1. Introduction

Welcome to **Finzo**, developed and operated by **BinaryKode Technologies** ("BinaryKode", "we", "our", or "us"). Finzo is a personal finance and loan management / calculator mobile application created to help you calculate, organize, and plan your loans, payment schedules, and payoff goals.
...
Finzo is built with a **local-first architecture** for your personal financial records. Your loan details, calculations, and payoff plans are stored directly on your physical device rather than in a centralized personal cloud database.

> **Transparent Disclosure:** We do not make misleading claims that "no data is collected" or that "nothing leaves your device." While your financial records remain stored on your device, Finzo utilizes standard third-party services for technical analytics, crash diagnostics, notifications, and advertising support as explained throughout this policy.
...
This financial information is **primarily stored locally on your device**. Finzo does not intentionally synchronize, copy, or upload your personal financial records to our remote database or configuration infrastructure.
...
This remote configuration contains only public application settings and **does not contain or collect users' financial records**.
...
- Finzo does **not** intentionally provide your financial records, payment history, loan balances, private notes, or credentials to advertising providers.
- Users may voluntarily choose to watch rewarded advertisements in exchange for temporary in-app rewards, such as temporary ad-free access periods. During an active ad-free period, standard advertisements are suppressed.
...
- **In-App Deletion:** You can delete any loan or payment record at any time using standard features inside the app.
- **Storage Reset / Uninstall:** Clearing application storage via your device settings or uninstalling Finzo deletes locally stored app records according to your operating system.
...
Finzo is designed for general audiences managing personal or business finances and is not specifically directed to children under 13. We do not knowingly collect personal information from children. If you believe a child has provided personal information to us, please contact us at [bhavyakoshiya.work@gmail.com](mailto:bhavyakoshiya.work@gmail.com).
...
- **Firebase Services (Google):** Used for analytics, crash diagnostics, notifications, and certain application services.
- **Google Mobile Ads:** Advertising delivery and campaign performance measurement.
...
- **Manage Financial Data:** Add, edit, or delete your calculation records and loan entries directly in the app.
- **Notifications:** Enable or disable notification permissions at any time via your device settings.
- **Advertising Controls:** Manage personalized advertising choices and reset advertising identifiers through your device operating system settings.
- **Uninstall Application:** Completely remove all locally stored app data by uninstalling Finzo from your device.
...
**Email:** [bhavyakoshiya.work@gmail.com](mailto:bhavyakoshiya.work@gmail.com)  
**Application:** Finzo — Personal Finance & Loan Calculator
...
| Area                  | Policy Summary                                                                     |
| --------------------- | ---------------------------------------------------------------------------------- |
| **Financial Records** | Primarily stored locally on your device and not uploaded to server databases.      |
| **Analytics**         | Used to understand app usage & improve Finzo; financial data is strictly excluded. |
| **Crash Reporting**   | Used to diagnose crashes & bugs without attaching personal financial records.      |
| **Notifications**     | Used for reminders when enabled; does not carry sensitive credentials.             |
| **Advertising**       | Used to support Finzo; networks process device data, not your financial entries.   |
| **Configuration**     | Used for public app parameters and update notices — never user financial data.     |
